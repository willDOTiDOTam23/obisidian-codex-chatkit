...
3) Run `python skills/markdown-to-docx/scripts/convert.py <input.md> [output.docx]`.
...
## Vault activity log
- 2025-12-07 00:59 UTC — Codex: Relocated helper script into `scripts/` to align with skill folder convention.
